...
--------------
 ...
 6. 可以用脚本简单的把码表映射到别的键盘布局下。如这个文件 gat-key-value-6000.dvp.txt 就是 dvp 的码表。用这个脚本转换： https://github.com/district10/dotfiles/tree/master/scripts
 7. 从码表生成 el 文件，也有一个简单的脚本。还是上方的链接。
